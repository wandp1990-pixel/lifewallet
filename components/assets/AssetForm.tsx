          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-1 bg-[var(--color-surface-sub)] border border-[var(--color-border)] rounded-xl px-3 focus-within:border-[var(--color-primary)] transition-colors">
                  <input
                    type="text"
                    inputMode="numeric"
